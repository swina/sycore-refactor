...
const { isDownloaded, isDownloading, downloadSound, deleteCache } = useFreesoundCache()
...
function togglePreview(sound) {
  ...
  previewAudio.pause()
  previewAudio.src = sound.previews['preview-hq-mp3'] || sound.previews['preview-lq-mp3'] || ''
      ...
      >
        ...
        <div class="shrink-0 flex flex-col gap-3 px-5 pt-4 pb-3 border-b border-neutral-800/60 bg-neutral-950/20">
          ...
          <div class="flex items-center gap-4 flex-wrap">
            ...
            <span v-if="totalCount > 0 && !isLoading" class="text-[9px] text-neutral-600 font-mono ml-auto">
