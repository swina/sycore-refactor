...
<template>
  <div v-if="isOpen" @click.self="ctxMenu = null">
      <div class="bg-neutral-950 border border-neutral-800 rounded-2xl overflow-hidden flex flex-col shadow-[0_0_10px_rgba(0,255,204,0.15)]" :style="panelStyle" v-show="!isMinimized" @mousedown.capture="bringToFront">
