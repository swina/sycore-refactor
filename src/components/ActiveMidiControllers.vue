<template>
  <div class="flex items-center gap-1" @mouseleave="hoverOpen = false">
    <!-- Enabled presets indicator -->
    <div
      class="flex items-center gap-1 px-2 py-1 rounded-full bg-neutral-900/60 border border-neutral-800/60 relative cursor-default"
    ...
    >
      ...
      <Transition name="popup">
        <div
          v-if="hoverOpen"
          class="absolute bottom-full left-0 mb-1 flex flex-col bg-neutral-900 border border-neutral-700 rounded-lg px-2 py-1.5 shadow-xl whitespace-nowrap z-[1060] min-w-[180px]"
          @mouseenter="hoverOpen = true"
