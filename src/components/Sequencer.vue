...
import { X, Play, Square, Settings, Plus, Trash2, ChevronUp, Zap, ChevronDown, ChevronLeft, ChevronRight, Save, Download, Keyboard, Piano, Circle, FolderOpen, FolderPlus } from 'lucide-vue-next'
      ...
      <div class="flex-1 overflow-auto p-4 bg-neutral-900/30 custom-scrollbar">
        <div class="inline-flex gap-1" style="min-width: max-content">
          ...
          >
            ...
            <!-- Play Indicator -->
            <div v-if="currentStep === idx && isPlaying" class="absolute inset-0 bg-amber-500/10 border-t-2 border-amber-400 pointer-events-none animate-pulse rounded-lg" />
          </div>
        </div>
      </div>
