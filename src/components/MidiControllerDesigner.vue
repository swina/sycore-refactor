...
const APP_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { action: 'cp_select_A',    label: 'Progression A' },
      { action: 'cp_select_B',    label: 'Progression B' },
      { action: 'cp_select_C',    label: 'Progression C' },
      { action: 'cp_select_D',    label: 'Progression D' },
      { action: 'cp_select_E',    label: 'Progression E' },
      { action: 'cp_select_F',    label: 'Progression F' },
      { action: 'cp_select_G',    label: 'Progression G' },
      { action: 'cp_select_H',    label: 'Progression H' },
