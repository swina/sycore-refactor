...
The **Arpeggiator** is a MIDI FLOW app source that generates note patterns from held chords, synced to a configurable BPM and subdivision. It sits as a cable-able node between your controller and instruments — play a chord and it automatically cycles through the notes in one of 10 pattern modes.
